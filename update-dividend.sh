...
export ETH_GAS=$(seth estimate $TOKEN_ADDRESS "updateDividendSettings(bool,uint256,bool)" true 0 true --rpc-url $ETH_RPC_URL)

seth send $TOKEN_ADDRESS "updateDividendSettings(bool,uint256,bool)" true 0 true --rpc-url $ETH_RPC_URL