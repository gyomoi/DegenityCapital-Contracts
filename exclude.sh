...
export ETH_GAS=$(seth estimate $TOKEN_ADDRESS "excludeFromFees(address,bool)" "0x4f21de894bbcf6e16d8f0b94e6870750dc87ce94" false --rpc-url $ETH_RPC_URL)

seth send $TOKEN_ADDRESS "excludeFromFees(address,bool)" "0x4f21de894bbcf6e16d8f0b94e6870750dc87ce94" false --rpc-url $ETH_RPC_URL