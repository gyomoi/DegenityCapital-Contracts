...
export ETH_GAS=$(seth estimate $TOKEN_ADDRESS "setMaxTxBPS(uint256)" 1000 --rpc-url $ETH_RPC_URL)

seth send $TOKEN_ADDRESS "setMaxTxBPS(uint256)" 1000 --rpc-url $ETH_RPC_URL